...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-warm min-h-[90vh] flex items-center">
      {/* Decorative Elements */}
      <div className="absolute top-20 left-10 w-32 h-32 bg-primary/20 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-secondary/20 rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-golden-light/30 rounded-full blur-2xl animate-float" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">Admissions Open 2025-2026</span>
            </motion.div>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">
              Nurturing young minds with quality education, discipline, and values.
              Join our family of learners and achievers in the heart of Sunsari, Nepal.
            </p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              ...
              <Link href="/about">
                <Button variant="outline" className="btn-secondary-school bg-transparent border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground">
                  Learn More
                </Button>
              </Link>
            </div>
            ...
            >
              ...
              <span className="text-sm">Itahari-17, Sunsari District, Nepal</span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -z-10 top-8 right-8 w-full h-full bg-gradient-hero rounded-3xl opacity-20" />
          </motion.div>
        </div>
      </div>
    </section>
