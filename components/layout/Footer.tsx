          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-10">
            ...
            <div className="w-full sm:w-[48%] lg:w-[30%]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-heading font-bold text-xl md:text-2xl">Standard Secondary</h3>
            ...
            <div className="w-full sm:w-[48%] lg:w-[30%]">
              ...
              <ul className="space-y-4 text-sm md:text-base">
                ...
                <li className="flex flex-wrap items-center gap-2">
                  ...
                  <a href="tel:025590085" className="hover:text-golden hover:underline">025-590085</a>
                  <span>|</span>
                  <a href="tel:+9779812363723" className="hover:text-golden hover:underline">+977 9812363723</a>
                </li>

                <li className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-golden" />
                  <a href="mailto:standardschool2051@gmail.com" className="hover:text-golden hover:underline">
      ...
      <div className="border-t border-border/20 py-6 px-4">
        <div className="container-school flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-4 text-sm">
            <Link href="/" className="text-muted-foreground hover:text-golden transition-colors">Privacy Policy</Link>
            <Link href="/" className="text-muted-foreground hover:text-golden transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>    {/* bottom bar ends here */}
    </footer>
  );
};
